...
from tests.unit.test_data import standard_create_request
...
def test_update_success(mocker: MockFixture) -> None:
    ...
    groups_client.get_by_object_id = mocker.MagicMock(return_value={"displayName": r.desiredResourceState.GroupName})
